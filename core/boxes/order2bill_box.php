 ...
 */
class order2billbox extends ModeleBoxes
{

    public $boxcode = "mybox";
    public $boximg = "order2bill@order2bill";
    public $boxlabel;
    public $depends = array("order2bill");
    public $db;
    public $param;
    ...
    public function loadBox($max = 5)
    {
        ...
        //include_once DOL_DOCUMENT_ROOT . "/order2bill/class/order2bill.class.php";
