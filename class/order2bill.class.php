...
class Order2Bill
{
	...
	function facture_add_line(Facture &$f, &$ord) {
		...
		foreach($ord->lines as $l){
			...
			$f->addline($l->description, $l->subprice, $l->qty, $l->tva_tx,$l->localtax1tx,$l->localtax2tx,$l->fk_product, $l->remise_percent,'','',0,0,'','HT',0,$orderline->product_type,-1,$l->special_code,0,0,$l->fk_fournprice,$l->pa_ht,$l->label,$l->array_options);
		}
